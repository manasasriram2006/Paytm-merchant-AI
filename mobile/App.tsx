...
export default function App() {
  ...
  const screens = { Home: <BusinessOverviewScreen onNavigate={setActiveTab} onOpenMore={openMore} />, Inventory: <InventoryAiScreen />, Forecast: <DemandForecastScreen />, Customers: <CustomersScreen />, AskAI: <AskAiScreen />, More: <MoreScreen initialPage={morePage} /> };
