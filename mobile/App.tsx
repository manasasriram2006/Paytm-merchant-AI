...
export default function App() {
  ...
  const screens = { Home: <BusinessOverviewScreen onNavigate={setActiveTab} onOpenMore={openMore} />, Inventory: <InventoryScreen />, Forecast: <ForecastingScreen />, Customers: <CustomersScreen />, AskAI: <AskAiScreen />, More: <MoreScreen initialPage={morePage} /> };
